...
country_mapping = {'Argentina':'AR', 'Australia':'AU', 'Austria':'AT', 'Bangladesh':'BD', 'Belgium':'BE',
                   ...
                   'Saint Barthelemy':'BL', 'Bermuda':'BM', 'Brunei Darussalam':'BN',
                   'Bolivia':'BO','Bonaire':'BQ', 'Brazil':'BR', 'Canada':'CA',"Cote d'Ivoire":'CI',
                   'Chile':'CL', 'China':'CN', 'Colombia':'CO', 'Czech Republic':'CZ', 'Germany':'DE',
                   'Denmark':'DK', 'Dominican Republic':'DO', 'Algeria':'DZ', 'Ecuador':'EC',
                   'Estonia':'EE', 'Egypt':'EG', 'Finland':'FI', 'France':'FR', 'Ghana':'GH',
                   'Greece':'GR', 'Guyana':'GY', 'Croatia':'HR', 'Hungary':'HU', 'India':'IN',
                   'Indonesia':'ID', 'Ireland':'IE', 'Israel':'IL', 'Iran':'IR', 'Iceland':'IS',
                   'Italy':'IT', 'Jamaica':'JM', 'Japan':'JP', 'Kenya':'KE', 'Lebanon':'LB',
                   'Sri Lanka':'LK', 'Lithuania':'LT', 'Luxembourg':'LU', 'Latvia':'LV', 'Morocco':'MA',
                   'Macedonia':'MK', 'Mauritius':'MU', 'Mexico':'MX', 'Namibia':'NA', 'Netherlands':'NL',
                   'Nigeria':'NG', 'Norway':'NO', 'New Zealand':'NZ', 'ON':'CA', 'Panama':'PA',
                   'Peru':'PE', 'Philippines':'PH', 'Pakistan':'PK', 'Poland':'PL', 'Portugal':'PT',
                   'Romania':'RO', 'Serbia':'RS', 'Russian Federation':'RU', 'Singapore':'SG',
                   'Slovenia':'SI', 'Slovakia':'SK', 'Suriname':'SR', 'Syrian Arab Republic':'SY',
                   'Thailand':'TH', 'Tanzania':'TZ', 'Ukraine':'UA', 'South Africa':'ZA', 
                   'South Korea':'KR', 'Spain':'ES', 'Sweden':'SE', 'Switzerland':'CH',
                   'Viet Nam':'VN', 'Zimbabwe':'ZW', 'Turkey':'TR', 'United Kingdom':'GB',
